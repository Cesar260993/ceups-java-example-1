...
public class TagBean {
	...
	public TagBean () {
		// Traer Data de la tabla opciones
	}
    ...
    public void changeLabels(){
    	...
    	model = new DefaultTagCloudModel();
    	model.addTag(new DefaultTagCloudItem("Chevrolet", 1));
        model.addTag(new DefaultTagCloudItem("Kia", "#", 5));
        model.addTag(new DefaultTagCloudItem("Toyota", 1));
    }
}
